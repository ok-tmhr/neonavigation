...
def generate_test_description():
    set_env = SetEnvironmentVariable("GCOV_PREFIX", "/tmp/gcov/dynamic_parameter_change")
    gtest = Node(
        package="planner_cspace",
        executable="test_dynamic_parameter_change",
    ...
    launch_file = IncludeLaunchDescription(
        XMLLaunchDescriptionSource(
            os.path.join(
                ...
                "test",
                "dynamic_parameter_change_rostest.test",
            )
        )
    )
